...
![metadata_menu]({{ site.baseurl }}/assets/images/app/import_metadata_menu.png)

![select_metadata_file]({{ site.baseurl }}/assets/images/app/open_metadata_file.png)

You can check the metadata file, similar to how you check the abundance data, through the `MGG` menu:

![check_metadata_menu]({{ site.baseurl }}/assets/images/app/check_metadata.png)
...
![metadata_view]({{ site.baseurl }}/assets/images/app/imported_metadata.png)
...
![annotated_net_metadata]({{ site.baseurl }}/assets/images/app/annotated_net_with_met_env.png)
