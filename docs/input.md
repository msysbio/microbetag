...
{:. note}
Make sure to rename the column `microbetag` should treat as the weight of your edges to `microbetag::weight` (see relative [tutorial](./tutorials/load.md#load-already-microbetag-annotated-networks)).
...
[1]:{{ site.url }}/microbetag/download/mgg/testAbund.tsv
[2]:{{ site.url }}/microbetag/download/mgg/metadata.tsv
[3]:{{ site.url }}/microbetag/download/mgg/edgelist.tsv
[4]:{{ site.url }}/microbetag/download/prep/seq_ab_tab.tsv
