...
![faprotax_example_denitrif]({{ site.baseurl }}/assets/images/faprotax_denitrification.png)
...
![phen_traits_example]({{ site.baseurl }}/assets/images/phen_traits_fmt.png)
...
![complementarity_kegg_example]({{ site.baseurl }}/assets/images/kegg_example.png){: width=80% }
...
![seed_concept]({{ site.baseurl }}/assets/images/seed_concept_example.png)
...
![seed_scores_example]({{site.baseurl}}/assets/images/seed-scores-examples.png)
...
![seedCompl]({{ site.baseurl }}/assets/images/app/seedKeggMap.png)





<!-- ![netcooperate seed example]({{ site.baseurl }}/assets/images/seed_network_example.png)
